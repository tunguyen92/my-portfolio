...
const ProfileSection = () => {
  ...
  const isInViewLeftSide = useInView(leftSideRef);

  const girlImageRef = useRef(null);
  const isInViewGirlImage = useInView(girlImageRef);

  const awardRef = useRef(null);
  const isInViewAward = useInView(awardRef);

  const selfTaughtRef = useRef(null);
  const isInViewSelfTaught = useInView(selfTaughtRef);

  const odioRef = useRef(null);
  const isInViewOdio = useInView(odioRef);

  const exploreRef = useRef(null);
  const isInViewExplore = useInView(exploreRef);
      ...
      <div className="sl:container">
        <div className="flex flex-col-reverse lg:flex-row">
          <motion.div
            ...
            animate={isInViewLeftSide ? animateFade : initialFadeUp}
          ...
          >
            <motion.img
              ...
              src={girl2}
              alt="girl-img2"
              animate={isInViewGirlImage ? animateFade : initialFadeLeft}
              transition={transitionInView}
            />
          ...
          <div className="lg:w-1/2 px-3">
            <motion.div
              ...
              animate={isInViewAward ? animateZoom : initialZoomIn}
              transition={transitionInView}
            >
            ...
            <motion.h3
              ...
              ref={selfTaughtRef}
              animate={isInViewSelfTaught ? animateFade : initialFadeUp}
              transition={transitionInView}
            >
            ...
            <motion.p
              ...
              ref={odioRef}
              animate={isInViewOdio ? animateFade : initialFadeUp}
              transition={transitionInView}
            >
            ...
            <HoverBlendedCursor>
              <motion.p
                ...
                ref={exploreRef}
                animate={isInViewExplore ? animateFade : initialFadeRight}
                transition={transitionInView}
              >
                <Link
                  to="/about"
