...
const initialZoomInRight = { opacity: 0, x: -100, y: 0, z: 0, scale: 0.6 };
const initialZoomInLeft = { opacity: 0, x: 100, y: 0, z: 0, scale: 0.6 };

const animateFade = { opacity: 1, x: 0, y: 0, z: 0 };
const animateZoom = { opacity: 1, scale: 1 };
const animateZoomAndFade = { opacity: 1, x: 0, y: 0, z: 0, scale: 1 };
